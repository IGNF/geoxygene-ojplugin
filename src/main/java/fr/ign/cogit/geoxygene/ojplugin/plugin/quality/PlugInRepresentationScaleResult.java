...
/**
 * Show the results of the representation scale estimation.
 * 
 * @author JFGirres
 * 
 */
public class PlugInRepresentationScaleResult extends FeatureInfoPlugIn {

  public static MultiInputDialog inputDialog;

  public static Double representationScale;
  ...
  public MultiInputDialog createDialog(final PlugInContext context) {
    ...
    Integer scale = representationScale.intValue();
    String txtRepresentationScale = scale.toString();
    ...
    inputDialog.addLabel("Representation scale = 1/" + txtRepresentationScale);
