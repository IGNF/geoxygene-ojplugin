...
public class ChargementPlugIn extends FeatureInfoPlugIn {

	@Override
	public void initialize(PlugInContext context) throws Exception {
		context.getFeatureInstaller().addMainMenuPlugin(this,
			new String[]{MenuNames.PLUGINS,"GeOxygene","Chargement des données"},
				"Chargement d'une table", false, null, null);

		context.getFeatureInstaller().addPopupMenuItem(
			context.getWorkbenchFrame().getCategoryPopupMenu(),
			this, "Chargement de données GeOxygene", false,
            GUIUtil.toSmallIcon(FeatureInfoTool.ICON), null);
	}
